...
export function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      {open && (
        <div className="w-[260px] overflow-hidden rounded-lg border border-border bg-card p-4 shadow-2xl">
          <a
            href={WHATSAPP_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center rounded-full bg-[#25D366] px-4 py-3 text-sm font-medium text-white shadow-lg transition-colors hover:bg-[#1ebe57]"
          >
